...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        CGSize dims = [self.labelText sizeWithAttributes:fontAttributes];
//        CGSize dims = [self.labelText sizeWithFont:self.labelFont];
        ...
        if (nil != self.detailsLabelText) {
            ...
            //            -  MSAA cleanup svaz 11/27/14
  //          NSDictionary *fontAttributes = @{NSFontAttributeName: detailsLabel.font};
//            CGSize labelSize = [detailsLabel.text sizeWithAttributes:fontAttributes: constrainedToSize:CGSizeMake(frame.size.width - 4*margin, maxHeight) lineBreakMode:detailsLabel.lineBreakMode];
