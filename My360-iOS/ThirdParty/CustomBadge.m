...
//	CGSize stringSize = [badgeString sizeWithFont:[UIFont boldSystemFontOfSize:12]];
    NSDictionary *fontAttributes = @{NSFontAttributeName: [UIFont boldSystemFontOfSize:12]};
...
//            -  MSAA cleanup svaz 11/27/14
        ...
        NSDictionary *fontAttributes = @{NSFontAttributeName: [UIFont boldSystemFontOfSize:sizeOfFont]};
...
//		[self.badgeText drawAtPoint:CGPointMake((rect.size.width/2-textSize.width/2), (rect.size.height/2-textSize.height/2)) withFont:textFont];
        ...
        [self.badgeText drawAtPoint:CGPointMake((rect.size.width/2-textSize.width/2), (rect.size.height/2-textSize.height/2)) withAttributes:fontAttributes];
	}
