...
@implementation DyskinesiaDayPercentageData
- (id)init {
    self = [super init];
    if (self) {
...
-(void)generateData {
    if ([AppDelegate hasConnectivity])
    {
        ...
        NSArray *objects = [Chart query:@"dyskinesia_day_percentage_report" params:queryAttributes error:&error];
