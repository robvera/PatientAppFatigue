...
- (id)init {
    ...
    if (self) {
        ...
        _dataKeys = [NSArray arrayWithObjects:@"InhalerData", nil]; //missedTreatments
...
-(void)generateData {
    if ([AppDelegate hasConnectivity])
    {
        ...
        NSArray *objects = [Chart query:@"inhaler_report" params:queryAttributes error:&error];
