//
//  DifficultyEverydayActivityData.m
//  BCPatient
//
...
@implementation DifficultyEverydayActivityData
- (id)init {
    self = [super init];
    if (self) {
...
-(void)generateData {
    if ([AppDelegate hasConnectivity])
    {
        ...
        NSArray *objects = [Chart query:@"difficulty_everyday_activity_rep" params:queryAttributes error:&error];
