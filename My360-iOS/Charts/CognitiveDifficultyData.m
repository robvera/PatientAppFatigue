...
@implementation CognitiveDifficultyData
- (id)init {
    self = [super init];
    if (self) {
        ...
        _dataKeys = [NSArray arrayWithObjects:@"CognitiveDifficultyData", nil];
...
-(void)generateData {
    if ([AppDelegate hasConnectivity])
    {
        ...
        NSArray *objects = [Chart query:@"cognitive_difficulty_report" params:queryAttributes error:&error];
