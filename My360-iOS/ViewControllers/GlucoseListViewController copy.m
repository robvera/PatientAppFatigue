...
- (void)reloadGlucoseListDataAnimated:(BOOL)animated
{
    ...
    if ([AppDelegate hasConnectivity])
    {
        ...
        [PatientGlucose query:@"my_unarchived_glucose" params:params offset:self.tableData.count limit:kListLength async:^(NSArray *objects, NSError *error) {
            ...
            if (self.navigationController.topViewController == self) {
                ...
                if (error) {
                    ...
                    if(!HAS_DATA){
                        ...
                        UILabel *newLabel = [[UILabel alloc]initWithFrame:CGRectMake(40, 160, 300, 40)];
                        [newLabel setFont:[UIFont systemFontOfSize:14.0]];
                        newLabel.text =@"Tap start adding glucose, insulin and";
                        newLabel.backgroundColor = [UIColor clearColor];
                        newLabel.textColor = [UIColor whiteColor];
                        
                        UILabel *newLabel2 = [[UILabel alloc]initWithFrame:CGRectMake(40, 180, 300, 40)];
                        ...
                        newArrow.head = CGPointMake(80, 5);
                        newArrow.tail = CGPointMake(80, 150);
