//
//  PatientCaregiver+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "PatientCaregiver+Remote.h"

@implementation PatientCaregiver (Remote)
...
+ (NSArray *)myCaregiverWithId:(NSNumber *)id error:(NSError **)error {
    ...
    return [self query:@"my_caregiver" params:params context:nil config:nil error:error];
}
...
+ (NSArray *)myCaregiverWithId:(NSNumber *)id context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_caregiver" params:params context:context config:nil error:error];
}
...
+ (NSArray *)myCaregiverWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"my_caregiver" params:params offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)myCaregiverWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_caregiver" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)myCaregiverWithId:(NSNumber *)id async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_caregiver" params:params context:nil config:nil async:callback];
}
...
+ (NSArray *)myCaregiverWithId:(NSNumber *)id context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_caregiver" params:params context:context config:nil async:callback];
}
...
+ (NSArray *)myCaregiverWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_caregiver" params:params offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)myCaregiverWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_caregiver" params:params offset:offset limit:limit context:context config:nil async:callback];
}
