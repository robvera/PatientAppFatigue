//
//  EducationalReading+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "EducationalReading+Remote.h"

@implementation EducationalReading (Remote)
...
+ (NSArray *)activeEducationalReadingsError:(NSError **)error {
    return [self query:@"active_educational_readings" params:nil context:nil config:nil error:error];
}

+ (NSArray *)activeEducationalReadingsWithContext:(id)context error:(NSError **)error {
    return [self query:@"active_educational_readings" params:nil context:context config:nil error:error];
}

+ (NSArray *)activeEducationalReadingsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    return [self query:@"active_educational_readings" params:nil offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)activeEducationalReadingsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    return [self query:@"active_educational_readings" params:nil offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeEducationalReadingsAsync:(APObjectsCallback)callback {
    return [self query:@"active_educational_readings" params:nil context:nil config:nil async:callback];
}

+ (NSArray *)activeEducationalReadingsWithContext:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_educational_readings" params:nil context:context config:nil async:callback];
}

+ (NSArray *)activeEducationalReadingsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    return [self query:@"active_educational_readings" params:nil offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeEducationalReadingsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_educational_readings" params:nil offset:offset limit:limit context:context config:nil async:callback];
}
