//
//  MedicalCondition+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "MedicalCondition+Remote.h"

@implementation MedicalCondition (Remote)
...
+ (NSArray *)activeMedicalConditionError:(NSError **)error {
    return [self query:@"active_medical_condition" params:nil context:nil config:nil error:error];
}

+ (NSArray *)activeMedicalConditionWithContext:(id)context error:(NSError **)error {
    return [self query:@"active_medical_condition" params:nil context:context config:nil error:error];
}

+ (NSArray *)activeMedicalConditionWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    return [self query:@"active_medical_condition" params:nil offset:offset limit:limit context:nil config:nil error:error];
}

+ (NSArray *)activeMedicalConditionWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    return [self query:@"active_medical_condition" params:nil offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeMedicalConditionAsync:(APObjectsCallback)callback {
    return [self query:@"active_medical_condition" params:nil context:nil config:nil async:callback];
}

+ (NSArray *)activeMedicalConditionWithContext:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_medical_condition" params:nil context:context config:nil async:callback];
}

+ (NSArray *)activeMedicalConditionWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    return [self query:@"active_medical_condition" params:nil offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeMedicalConditionWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_medical_condition" params:nil offset:offset limit:limit context:context config:nil async:callback];
}
