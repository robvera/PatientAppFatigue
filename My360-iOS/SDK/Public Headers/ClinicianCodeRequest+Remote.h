//
//  ClinicianCodeRequest+Remote.h
//  AnyPresence SDK
//

/*!
 @header ClinicianCodeRequest+Remote
 @abstract Remote category for ClinicianCodeRequest class
 */

#import "ClinicianCodeRequest.h"

/*!
 @category ClinicianCodeRequest (Remote)
 @abstract Adds remote CRUD capabilities to ClinicianCodeRequest.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface ClinicianCodeRequest (Remote)
...
/*!
 @method matchByPatientIdWithPatientId:error:
 @abstract Fetches objects matching query scope "match_by_patient_id" from remote server.
...
/*!
 @method matchByPatientIdWithPatientId:context:error:
 @abstract Fetches objects matching query scope "match_by_patient_id" from remote server.
 @param patientId Scope parameter - patientId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method matchByPatientIdWithPatientId:offset:limit:error:
 @abstract Fetches objects matching query scope "match_by_patient_id" from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method matchByPatientIdWithPatientId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "match_by_patient_id" from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method matchByPatientIdWithPatientId:async:
 @abstract Returns cached objects matching query scope "match_by_patient_id", then fetches fresh ones from remote server.
 @param patientId Scope parameter - patientId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method matchByPatientIdWithPatientId:context:async:
 @abstract Returns cached objects matching query scope "match_by_patient_id", then fetches fresh ones from remote server.
 @param patientId Scope parameter - patientId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method matchByPatientIdWithPatientId:offset:limit:async:
 @abstract Returns cached objects matching query scope "match_by_patient_id", then fetches fresh ones from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method matchByPatientIdWithPatientId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "match_by_patient_id", then fetches fresh ones from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
