//
//  PatientMedicalCondition+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientMedicalCondition+Remote
 @abstract Remote category for PatientMedicalCondition class
 */

#import "PatientMedicalCondition.h"

/*!
 @category PatientMedicalCondition (Remote)
 @abstract Adds remote CRUD capabilities to PatientMedicalCondition.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientMedicalCondition (Remote)
...
/*!
 @method unarchivedPatientMedCondWithPatientId:error:
 @abstract Fetches objects matching query scope "unarchived_patient_med_cond" from remote server.
...
/*!
 @method unarchivedPatientMedCondWithPatientId:context:error:
 @abstract Fetches objects matching query scope "unarchived_patient_med_cond" from remote server.
 @param patientId Scope parameter - patientId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method unarchivedPatientMedCondWithPatientId:offset:limit:error:
 @abstract Fetches objects matching query scope "unarchived_patient_med_cond" from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method unarchivedPatientMedCondWithPatientId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "unarchived_patient_med_cond" from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method myMedicalConditionsWithId:error:
 @abstract Fetches objects matching query scope "my_medical_conditions" from remote server.
...
/*!
 @method myMedicalConditionsWithId:context:error:
 @abstract Fetches objects matching query scope "my_medical_conditions" from remote server.
 @param id Scope parameter - id.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method myMedicalConditionsWithId:offset:limit:error:
 @abstract Fetches objects matching query scope "my_medical_conditions" from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method myMedicalConditionsWithId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "my_medical_conditions" from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method unarchivedPatientMedCondWithPatientId:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_med_cond", then fetches fresh ones from remote server.
 @param patientId Scope parameter - patientId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method unarchivedPatientMedCondWithPatientId:context:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_med_cond", then fetches fresh ones from remote server.
 @param patientId Scope parameter - patientId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method unarchivedPatientMedCondWithPatientId:offset:limit:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_med_cond", then fetches fresh ones from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method unarchivedPatientMedCondWithPatientId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_med_cond", then fetches fresh ones from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method myMedicalConditionsWithId:async:
 @abstract Returns cached objects matching query scope "my_medical_conditions", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method myMedicalConditionsWithId:context:async:
 @abstract Returns cached objects matching query scope "my_medical_conditions", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method myMedicalConditionsWithId:offset:limit:async:
 @abstract Returns cached objects matching query scope "my_medical_conditions", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method myMedicalConditionsWithId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "my_medical_conditions", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
