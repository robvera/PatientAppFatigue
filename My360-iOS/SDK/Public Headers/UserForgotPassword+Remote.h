//
//  UserForgotPassword+Remote.h
//  AnyPresence SDK
//

/*!
 @header UserForgotPassword+Remote
 @abstract Remote category for UserForgotPassword class
 */

#import "UserForgotPassword.h"

/*!
 @category UserForgotPassword (Remote)
 @abstract Adds remote CRUD capabilities to UserForgotPassword.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface UserForgotPassword (Remote)
