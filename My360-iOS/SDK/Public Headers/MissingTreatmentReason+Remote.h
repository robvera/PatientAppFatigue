//
//  MissingTreatmentReason+Remote.h
//  AnyPresence SDK
//

/*!
 @header MissingTreatmentReason+Remote
 @abstract Remote category for MissingTreatmentReason class
 */

#import "MissingTreatmentReason.h"

/*!
 @category MissingTreatmentReason (Remote)
 @abstract Adds remote CRUD capabilities to MissingTreatmentReason.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface MissingTreatmentReason (Remote)
...
/*!
 @method activeMissingTreatmentsError:
 @abstract Fetches objects matching query scope "active_missing_treatments" from remote server.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMissingTreatmentsError:(NSError **)error;

/*!
 @method activeMissingTreatmentsWithContext:error:
 @abstract Fetches objects matching query scope "active_missing_treatments" from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMissingTreatmentsWithContext:(id)context error:(NSError **)error;

/*!
 @method activeMissingTreatmentsWithOffset:limit:error:
 @abstract Fetches objects matching query scope "active_missing_treatments" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMissingTreatmentsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method activeMissingTreatmentsWithOffset:limit:context:error:
 @abstract Fetches objects matching query scope "active_missing_treatments" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of objects.
 */
+ (NSArray *)activeMissingTreatmentsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method activeMissingTreatmentsAsync:
 @abstract Returns cached objects matching query scope "active_missing_treatments", then fetches fresh ones from remote server.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMissingTreatmentsAsync:(APObjectsCallback)callback;

/*!
 @method activeMissingTreatmentsWithContext:async:
 @abstract Returns cached objects matching query scope "active_missing_treatments", then fetches fresh ones from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMissingTreatmentsWithContext:(id)context async:(APObjectsCallback)callback;

/*!
 @method activeMissingTreatmentsWithOffset:limit:async:
 @abstract Returns cached objects matching query scope "active_missing_treatments", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMissingTreatmentsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method activeMissingTreatmentsWithOffset:limit:context:async:
 @abstract Returns cached objects matching query scope "active_missing_treatments", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)activeMissingTreatmentsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
