...
/*!
 @header Clinician+Remote
 @abstract Remote category for Clinician class
 */

#import "Clinician.h"

/*!
 @category Clinician (Remote)
 @abstract Adds remote CRUD capabilities to Clinician.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Clinician (Remote)
