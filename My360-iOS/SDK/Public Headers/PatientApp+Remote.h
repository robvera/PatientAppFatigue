...
/*!
 @header PatientApp+Remote
 @abstract Remote category for PatientApp class
 */

#import "PatientApp.h"

/*!
 @category PatientApp (Remote)
 @abstract Adds remote CRUD capabilities to PatientApp.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientApp (Remote)
...
/*!
 @method myAppsWithId:error:
 @abstract Fetches objects matching query scope "my_apps" from remote server.
...
/*!
 @method myAppsWithId:context:error:
 @abstract Fetches objects matching query scope "my_apps" from remote server.
 @param id Scope parameter - id.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method myAppsWithId:offset:limit:error:
 @abstract Fetches objects matching query scope "my_apps" from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method myAppsWithId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "my_apps" from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method patientAppRecordCountWithId:appId:error:
 @abstract Executes aggregate query "patient_app_record_count" on remote server.
 @param id Scope parameter - id.
...
/*!
 @method patientAppRecordCountWithId:appId:context:error:
 @abstract Executes aggregate query "patient_app_record_count" on remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method myAppsWithId:async:
 @abstract Returns cached objects matching query scope "my_apps", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method myAppsWithId:context:async:
 @abstract Returns cached objects matching query scope "my_apps", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method myAppsWithId:offset:limit:async:
 @abstract Returns cached objects matching query scope "my_apps", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method myAppsWithId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "my_apps", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method patientAppRecordCountWithId:appId:async:
 @abstract Executes aggregate query "patient_app_record_count" on remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method patientAppRecordCountWithId:appId:context:async:
 @abstract Executes aggregate query "patient_app_record_count" on remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
