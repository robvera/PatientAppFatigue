//
//  EducationalReading+Remote.h
//  AnyPresence SDK
//

/*!
 @header EducationalReading+Remote
 @abstract Remote category for EducationalReading class
 */

#import "EducationalReading.h"

/*!
 @category EducationalReading (Remote)
 @abstract Adds remote CRUD capabilities to EducationalReading.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface EducationalReading (Remote)
...
/*!
 @method activeEducationalReadingsError:
 @abstract Fetches objects matching query scope "active_educational_readings" from remote server.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeEducationalReadingsError:(NSError **)error;

/*!
 @method activeEducationalReadingsWithContext:error:
 @abstract Fetches objects matching query scope "active_educational_readings" from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeEducationalReadingsWithContext:(id)context error:(NSError **)error;

/*!
 @method activeEducationalReadingsWithOffset:limit:error:
 @abstract Fetches objects matching query scope "active_educational_readings" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeEducationalReadingsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method activeEducationalReadingsWithOffset:limit:context:error:
 @abstract Fetches objects matching query scope "active_educational_readings" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of objects.
 */
+ (NSArray *)activeEducationalReadingsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method activeEducationalReadingsAsync:
 @abstract Returns cached objects matching query scope "active_educational_readings", then fetches fresh ones from remote server.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeEducationalReadingsAsync:(APObjectsCallback)callback;

/*!
 @method activeEducationalReadingsWithContext:async:
 @abstract Returns cached objects matching query scope "active_educational_readings", then fetches fresh ones from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeEducationalReadingsWithContext:(id)context async:(APObjectsCallback)callback;

/*!
 @method activeEducationalReadingsWithOffset:limit:async:
 @abstract Returns cached objects matching query scope "active_educational_readings", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeEducationalReadingsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method activeEducationalReadingsWithOffset:limit:context:async:
 @abstract Returns cached objects matching query scope "active_educational_readings", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)activeEducationalReadingsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
