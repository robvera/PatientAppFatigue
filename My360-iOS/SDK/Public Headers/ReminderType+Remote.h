//
//  ReminderType+Remote.h
//  AnyPresence SDK
//

/*!
 @header ReminderType+Remote
 @abstract Remote category for ReminderType class
 */

#import "ReminderType.h"

/*!
 @category ReminderType (Remote)
 @abstract Adds remote CRUD capabilities to ReminderType.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface ReminderType (Remote)
