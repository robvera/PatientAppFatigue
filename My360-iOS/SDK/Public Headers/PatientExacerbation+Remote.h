//
//  PatientExacerbation+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientExacerbation+Remote
 @abstract Remote category for PatientExacerbation class
 */

#import "PatientExacerbation.h"

/*!
 @category PatientExacerbation (Remote)
 @abstract Adds remote CRUD capabilities to PatientExacerbation.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientExacerbation (Remote)
...
/*!
 @method unarchivedPatientExacerbationsWithPatientId:appId:error:
 @abstract Fetches objects matching query scope "unarchived_patient_exacerbations" from remote server.
...
/*!
 @method unarchivedPatientExacerbationsWithPatientId:appId:context:error:
 @abstract Fetches objects matching query scope "unarchived_patient_exacerbations" from remote server.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method unarchivedPatientExacerbationsWithPatientId:appId:offset:limit:error:
 @abstract Fetches objects matching query scope "unarchived_patient_exacerbations" from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method unarchivedPatientExacerbationsWithPatientId:appId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "unarchived_patient_exacerbations" from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
...
/*!
 @method myUnarchivedExacerbationsWithId:appId:error:
 @abstract Fetches objects matching query scope "my_unarchived_exacerbations" from remote server.
...
/*!
 @method myUnarchivedExacerbationsWithId:appId:context:error:
 @abstract Fetches objects matching query scope "my_unarchived_exacerbations" from remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method myUnarchivedExacerbationsWithId:appId:offset:limit:error:
 @abstract Fetches objects matching query scope "my_unarchived_exacerbations" from remote server, with pagination.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method myUnarchivedExacerbationsWithId:appId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "my_unarchived_exacerbations" from remote server, with pagination.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
...
/*!
 @method chartExacerbationReasonsWithStartDate:endDate:patientId:appId:error:
 @abstract Fetches objects matching query scope "chart_exacerbation_reasons" from remote server.
...
/*!
 @method chartExacerbationReasonsWithStartDate:endDate:patientId:appId:context:error:
 @abstract Fetches objects matching query scope "chart_exacerbation_reasons" from remote server.
 @param startDate Scope parameter - startDate.
 @param endDate Scope parameter - endDate.
 @param patientId Scope parameter - patientId.
...
/*!
 @method chartExacerbationReasonsWithStartDate:endDate:patientId:appId:offset:limit:error:
 @abstract Fetches objects matching query scope "chart_exacerbation_reasons" from remote server, with pagination.
 @param startDate Scope parameter - startDate.
 @param endDate Scope parameter - endDate.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
...
/*!
 @method chartExacerbationReasonsWithStartDate:endDate:patientId:appId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "chart_exacerbation_reasons" from remote server, with pagination.
 @param startDate Scope parameter - startDate.
 @param endDate Scope parameter - endDate.
 @param patientId Scope parameter - patientId.
...
/*!
 @method unarchivedPatientExacerbationsWithPatientId:appId:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_exacerbations", then fetches fresh ones from remote server.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
...
/*!
 @method unarchivedPatientExacerbationsWithPatientId:appId:context:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_exacerbations", then fetches fresh ones from remote server.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method unarchivedPatientExacerbationsWithPatientId:appId:offset:limit:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_exacerbations", then fetches fresh ones from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method unarchivedPatientExacerbationsWithPatientId:appId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_exacerbations", then fetches fresh ones from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
...
/*!
 @method myUnarchivedExacerbationsWithId:appId:async:
 @abstract Returns cached objects matching query scope "my_unarchived_exacerbations", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
...
/*!
 @method myUnarchivedExacerbationsWithId:appId:context:async:
 @abstract Returns cached objects matching query scope "my_unarchived_exacerbations", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method myUnarchivedExacerbationsWithId:appId:offset:limit:async:
 @abstract Returns cached objects matching query scope "my_unarchived_exacerbations", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method myUnarchivedExacerbationsWithId:appId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "my_unarchived_exacerbations", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
...
/*!
 @method chartExacerbationReasonsWithStartDate:endDate:patientId:appId:async:
 @abstract Returns cached objects matching query scope "chart_exacerbation_reasons", then fetches fresh ones from remote server.
 @param startDate Scope parameter - startDate.
 @param endDate Scope parameter - endDate.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
...
/*!
 @method chartExacerbationReasonsWithStartDate:endDate:patientId:appId:context:async:
 @abstract Returns cached objects matching query scope "chart_exacerbation_reasons", then fetches fresh ones from remote server.
 @param startDate Scope parameter - startDate.
 @param endDate Scope parameter - endDate.
 @param patientId Scope parameter - patientId.
...
/*!
 @method chartExacerbationReasonsWithStartDate:endDate:patientId:appId:offset:limit:async:
 @abstract Returns cached objects matching query scope "chart_exacerbation_reasons", then fetches fresh ones from remote server, with pagination.
 @param startDate Scope parameter - startDate.
 @param endDate Scope parameter - endDate.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
...
/*!
 @method chartExacerbationReasonsWithStartDate:endDate:patientId:appId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "chart_exacerbation_reasons", then fetches fresh ones from remote server, with pagination.
 @param startDate Scope parameter - startDate.
 @param endDate Scope parameter - endDate.
 @param patientId Scope parameter - patientId.
