...
/*!
 @header DosageUom+Remote
 @abstract Remote category for DosageUom class
 */

#import "DosageUom.h"

/*!
 @category DosageUom (Remote)
 @abstract Adds remote CRUD capabilities to DosageUom.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface DosageUom (Remote)
...
/*!
 @method activeDosageUomError:
 @abstract Fetches objects matching query scope "active_dosage_uom" from remote server.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeDosageUomError:(NSError **)error;

/*!
 @method activeDosageUomWithContext:error:
 @abstract Fetches objects matching query scope "active_dosage_uom" from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeDosageUomWithContext:(id)context error:(NSError **)error;

/*!
 @method activeDosageUomWithOffset:limit:error:
 @abstract Fetches objects matching query scope "active_dosage_uom" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeDosageUomWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method activeDosageUomWithOffset:limit:context:error:
 @abstract Fetches objects matching query scope "active_dosage_uom" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of objects.
 */
+ (NSArray *)activeDosageUomWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method activeDosageUomAsync:
 @abstract Returns cached objects matching query scope "active_dosage_uom", then fetches fresh ones from remote server.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeDosageUomAsync:(APObjectsCallback)callback;

/*!
 @method activeDosageUomWithContext:async:
 @abstract Returns cached objects matching query scope "active_dosage_uom", then fetches fresh ones from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeDosageUomWithContext:(id)context async:(APObjectsCallback)callback;

/*!
 @method activeDosageUomWithOffset:limit:async:
 @abstract Returns cached objects matching query scope "active_dosage_uom", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeDosageUomWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method activeDosageUomWithOffset:limit:context:async:
 @abstract Returns cached objects matching query scope "active_dosage_uom", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)activeDosageUomWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
