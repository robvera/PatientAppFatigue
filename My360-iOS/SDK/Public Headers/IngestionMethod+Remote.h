//
//  IngestionMethod+Remote.h
//  AnyPresence SDK
//

/*!
 @header IngestionMethod+Remote
 @abstract Remote category for IngestionMethod class
 */

#import "IngestionMethod.h"

/*!
 @category IngestionMethod (Remote)
 @abstract Adds remote CRUD capabilities to IngestionMethod.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface IngestionMethod (Remote)
...
/*!
 @method activeIngestionMethodsError:
 @abstract Fetches objects matching query scope "active_ingestion_methods" from remote server.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeIngestionMethodsError:(NSError **)error;

/*!
 @method activeIngestionMethodsWithContext:error:
 @abstract Fetches objects matching query scope "active_ingestion_methods" from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeIngestionMethodsWithContext:(id)context error:(NSError **)error;

/*!
 @method activeIngestionMethodsWithOffset:limit:error:
 @abstract Fetches objects matching query scope "active_ingestion_methods" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeIngestionMethodsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method activeIngestionMethodsWithOffset:limit:context:error:
 @abstract Fetches objects matching query scope "active_ingestion_methods" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of objects.
 */
+ (NSArray *)activeIngestionMethodsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method activeIngestionMethodsAsync:
 @abstract Returns cached objects matching query scope "active_ingestion_methods", then fetches fresh ones from remote server.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeIngestionMethodsAsync:(APObjectsCallback)callback;

/*!
 @method activeIngestionMethodsWithContext:async:
 @abstract Returns cached objects matching query scope "active_ingestion_methods", then fetches fresh ones from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeIngestionMethodsWithContext:(id)context async:(APObjectsCallback)callback;

/*!
 @method activeIngestionMethodsWithOffset:limit:async:
 @abstract Returns cached objects matching query scope "active_ingestion_methods", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeIngestionMethodsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method activeIngestionMethodsWithOffset:limit:context:async:
 @abstract Returns cached objects matching query scope "active_ingestion_methods", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)activeIngestionMethodsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
