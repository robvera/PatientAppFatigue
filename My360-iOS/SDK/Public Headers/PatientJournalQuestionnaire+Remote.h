//
//  PatientJournalQuestionnaire+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientJournalQuestionnaire+Remote
 @abstract Remote category for PatientJournalQuestionnaire class
 */

#import "PatientJournalQuestionnaire.h"

/*!
 @category PatientJournalQuestionnaire (Remote)
 @abstract Adds remote CRUD capabilities to PatientJournalQuestionnaire.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientJournalQuestionnaire (Remote)
