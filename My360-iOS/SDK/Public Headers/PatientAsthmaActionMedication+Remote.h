//
//  PatientAsthmaActionMedication+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientAsthmaActionMedication+Remote
 @abstract Remote category for PatientAsthmaActionMedication class
 */

#import "PatientAsthmaActionMedication.h"

/*!
 @category PatientAsthmaActionMedication (Remote)
 @abstract Adds remote CRUD capabilities to PatientAsthmaActionMedication.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientAsthmaActionMedication (Remote)
