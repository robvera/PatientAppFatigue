//
//  MedicalCondition+Remote.h
//  AnyPresence SDK
//

/*!
 @header MedicalCondition+Remote
 @abstract Remote category for MedicalCondition class
 */

#import "MedicalCondition.h"

/*!
 @category MedicalCondition (Remote)
 @abstract Adds remote CRUD capabilities to MedicalCondition.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface MedicalCondition (Remote)
...
/*!
 @method activeMedicalConditionError:
 @abstract Fetches objects matching query scope "active_medical_condition" from remote server.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMedicalConditionError:(NSError **)error;

/*!
 @method activeMedicalConditionWithContext:error:
 @abstract Fetches objects matching query scope "active_medical_condition" from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMedicalConditionWithContext:(id)context error:(NSError **)error;

/*!
 @method activeMedicalConditionWithOffset:limit:error:
 @abstract Fetches objects matching query scope "active_medical_condition" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMedicalConditionWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method activeMedicalConditionWithOffset:limit:context:error:
 @abstract Fetches objects matching query scope "active_medical_condition" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of objects.
 */
+ (NSArray *)activeMedicalConditionWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method activeMedicalConditionAsync:
 @abstract Returns cached objects matching query scope "active_medical_condition", then fetches fresh ones from remote server.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMedicalConditionAsync:(APObjectsCallback)callback;

/*!
 @method activeMedicalConditionWithContext:async:
 @abstract Returns cached objects matching query scope "active_medical_condition", then fetches fresh ones from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMedicalConditionWithContext:(id)context async:(APObjectsCallback)callback;

/*!
 @method activeMedicalConditionWithOffset:limit:async:
 @abstract Returns cached objects matching query scope "active_medical_condition", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMedicalConditionWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method activeMedicalConditionWithOffset:limit:context:async:
 @abstract Returns cached objects matching query scope "active_medical_condition", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)activeMedicalConditionWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
