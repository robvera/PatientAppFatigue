//
//  PatientGlucose+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientGlucose+Remote
 @abstract Remote category for PatientGlucose class
 */

#import "PatientGlucose.h"

/*!
 @category PatientGlucose (Remote)
 @abstract Adds remote CRUD capabilities to PatientGlucose.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientGlucose (Remote)
...
/*!
 @method myUnarchivedGlucoseWithId:appId:fromDate:toDate:error:
 @abstract Fetches objects matching query scope "my_unarchived_glucose" from remote server.
...
/*!
 @method myUnarchivedGlucoseWithId:appId:fromDate:toDate:context:error:
 @abstract Fetches objects matching query scope "my_unarchived_glucose" from remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param fromDate Scope parameter - fromDate.
...
/*!
 @method myUnarchivedGlucoseWithId:appId:fromDate:toDate:offset:limit:error:
 @abstract Fetches objects matching query scope "my_unarchived_glucose" from remote server, with pagination.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param fromDate Scope parameter - fromDate.
 @param toDate Scope parameter - toDate.
...
/*!
 @method myUnarchivedGlucoseWithId:appId:fromDate:toDate:offset:limit:context:error:
 @abstract Fetches objects matching query scope "my_unarchived_glucose" from remote server, with pagination.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param fromDate Scope parameter - fromDate.
...
/*!
 @method unarchivedPatientGlucoseWithPatientId:appId:error:
 @abstract Fetches objects matching query scope "unarchived_patient_glucose" from remote server.
...
/*!
 @method unarchivedPatientGlucoseWithPatientId:appId:context:error:
 @abstract Fetches objects matching query scope "unarchived_patient_glucose" from remote server.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method unarchivedPatientGlucoseWithPatientId:appId:offset:limit:error:
 @abstract Fetches objects matching query scope "unarchived_patient_glucose" from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method unarchivedPatientGlucoseWithPatientId:appId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "unarchived_patient_glucose" from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
...
/*!
 @method myUnarchivedGlucoseWithId:appId:fromDate:toDate:async:
 @abstract Returns cached objects matching query scope "my_unarchived_glucose", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param fromDate Scope parameter - fromDate.
 @param toDate Scope parameter - toDate.
...
/*!
 @method myUnarchivedGlucoseWithId:appId:fromDate:toDate:context:async:
 @abstract Returns cached objects matching query scope "my_unarchived_glucose", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param fromDate Scope parameter - fromDate.
...
/*!
 @method myUnarchivedGlucoseWithId:appId:fromDate:toDate:offset:limit:async:
 @abstract Returns cached objects matching query scope "my_unarchived_glucose", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param fromDate Scope parameter - fromDate.
 @param toDate Scope parameter - toDate.
...
/*!
 @method myUnarchivedGlucoseWithId:appId:fromDate:toDate:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "my_unarchived_glucose", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param appId Scope parameter - appId.
 @param fromDate Scope parameter - fromDate.
...
/*!
 @method unarchivedPatientGlucoseWithPatientId:appId:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_glucose", then fetches fresh ones from remote server.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
...
/*!
 @method unarchivedPatientGlucoseWithPatientId:appId:context:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_glucose", then fetches fresh ones from remote server.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
...
/*!
 @method unarchivedPatientGlucoseWithPatientId:appId:offset:limit:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_glucose", then fetches fresh ones from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method unarchivedPatientGlucoseWithPatientId:appId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_glucose", then fetches fresh ones from remote server, with pagination.
 @param patientId Scope parameter - patientId.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
