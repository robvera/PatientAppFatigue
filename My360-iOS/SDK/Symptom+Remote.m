...
#import "Symptom+Remote.h"

@implementation Symptom (Remote)
...
+ (NSArray *)activeSymptomsWithAppId:(NSNumber *)appId error:(NSError **)error {
    ...
    return [self query:@"active_symptoms" params:params context:nil config:nil error:error];
}
...
+ (NSArray *)activeSymptomsWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error {
    ...
    return [self query:@"active_symptoms" params:params context:context config:nil error:error];
}
...
+ (NSArray *)activeSymptomsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"active_symptoms" params:params offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)activeSymptomsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"active_symptoms" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeSymptomsWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_symptoms" params:params context:nil config:nil async:callback];
}
...
+ (NSArray *)activeSymptomsWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_symptoms" params:params context:context config:nil async:callback];
}
...
+ (NSArray *)activeSymptomsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_symptoms" params:params offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeSymptomsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_symptoms" params:params offset:offset limit:limit context:context config:nil async:callback];
}
