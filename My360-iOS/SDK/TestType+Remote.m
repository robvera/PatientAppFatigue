...
#import "TestType+Remote.h"

@implementation TestType (Remote)
...
+ (NSArray *)activeTestTypesWithAppId:(NSNumber *)appId error:(NSError **)error {
    ...
    return [self query:@"active_test_types" params:params context:nil config:nil error:error];
}
...
+ (NSArray *)activeTestTypesWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error {
    ...
    return [self query:@"active_test_types" params:params context:context config:nil error:error];
}
...
+ (NSArray *)activeTestTypesWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"active_test_types" params:params offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)activeTestTypesWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"active_test_types" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeTestTypesWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_test_types" params:params context:nil config:nil async:callback];
}
...
+ (NSArray *)activeTestTypesWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_test_types" params:params context:context config:nil async:callback];
}
...
+ (NSArray *)activeTestTypesWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_test_types" params:params offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeTestTypesWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_test_types" params:params offset:offset limit:limit context:context config:nil async:callback];
}
