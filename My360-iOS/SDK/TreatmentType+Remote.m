//
//  TreatmentType+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "TreatmentType+Remote.h"

@implementation TreatmentType (Remote)
...
+ (NSArray *)activeTreatmentTypesWithAppId:(NSNumber *)appId error:(NSError **)error {
    ...
    return [self query:@"active_treatment_types" params:params context:nil config:nil error:error];
}
...
+ (NSArray *)activeTreatmentTypesWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error {
    ...
    return [self query:@"active_treatment_types" params:params context:context config:nil error:error];
}
...
+ (NSArray *)activeTreatmentTypesWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"active_treatment_types" params:params offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)activeTreatmentTypesWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"active_treatment_types" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeTreatmentTypesWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_treatment_types" params:params context:nil config:nil async:callback];
}
...
+ (NSArray *)activeTreatmentTypesWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_treatment_types" params:params context:context config:nil async:callback];
}
...
+ (NSArray *)activeTreatmentTypesWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_treatment_types" params:params offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeTreatmentTypesWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_treatment_types" params:params offset:offset limit:limit context:context config:nil async:callback];
}
