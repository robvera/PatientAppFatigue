...
#import "Setting+Remote.h"

@implementation Setting (Remote)
...
+ (NSArray *)myAppSettingWithAppId:(NSNumber *)appId error:(NSError **)error {
    ...
    return [self query:@"my_app_setting" params:params context:nil config:nil error:error];
}
...
+ (NSArray *)myAppSettingWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_app_setting" params:params context:context config:nil error:error];
}
...
+ (NSArray *)myAppSettingWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"my_app_setting" params:params offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)myAppSettingWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_app_setting" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)myAppSettingWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_app_setting" params:params context:nil config:nil async:callback];
}
...
+ (NSArray *)myAppSettingWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_app_setting" params:params context:context config:nil async:callback];
}
...
+ (NSArray *)myAppSettingWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_app_setting" params:params offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)myAppSettingWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_app_setting" params:params offset:offset limit:limit context:context config:nil async:callback];
}
