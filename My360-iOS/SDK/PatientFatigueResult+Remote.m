//
//  PatientFatigueResult+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "PatientFatigueResult+Remote.h"

@implementation PatientFatigueResult (Remote)
...
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id error:(NSError **)error {
    ...
    return [self query:@"my_unarchived_fatigue" params:params context:nil config:nil error:error];
}
...
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_unarchived_fatigue" params:params context:context config:nil error:error];
}
...
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"my_unarchived_fatigue" params:params offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_unarchived_fatigue" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_unarchived_fatigue" params:params context:nil config:nil async:callback];
}
...
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_unarchived_fatigue" params:params context:context config:nil async:callback];
}
...
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_unarchived_fatigue" params:params offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_unarchived_fatigue" params:params offset:offset limit:limit context:context config:nil async:callback];
}
