...
#import "TestType.h"
#import "TestType$AP$.h"
#import "PatientLabResult.h"
#import "AnyPresenceAPI.h"

@interface TestType ()

@property (nonatomic, strong) TestType$AP$ * internal;
...
- (NSString *)testTypeCat {
    return ThreadSafeReturn(^id{
        return self.internal.testTypeCat;
    });
}

- (void)setTestTypeCat:(NSString *)testTypeCat {
    ThreadSafe(^{
        self.internal.testTypeCat = testTypeCat;
    });
}
