//
//  TreatmentSchedule+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "TreatmentSchedule+Remote.h"

@implementation TreatmentSchedule (Remote)
...
+ (NSArray *)activeTreatmentSchedulesError:(NSError **)error {
    return [self query:@"active_treatment_schedules" params:nil context:nil config:nil error:error];
}

+ (NSArray *)activeTreatmentSchedulesWithContext:(id)context error:(NSError **)error {
    return [self query:@"active_treatment_schedules" params:nil context:context config:nil error:error];
}

+ (NSArray *)activeTreatmentSchedulesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    return [self query:@"active_treatment_schedules" params:nil offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)activeTreatmentSchedulesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    return [self query:@"active_treatment_schedules" params:nil offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeTreatmentSchedulesAsync:(APObjectsCallback)callback {
    return [self query:@"active_treatment_schedules" params:nil context:nil config:nil async:callback];
}

+ (NSArray *)activeTreatmentSchedulesWithContext:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_treatment_schedules" params:nil context:context config:nil async:callback];
}

+ (NSArray *)activeTreatmentSchedulesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    return [self query:@"active_treatment_schedules" params:nil offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeTreatmentSchedulesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_treatment_schedules" params:nil offset:offset limit:limit context:context config:nil async:callback];
}
