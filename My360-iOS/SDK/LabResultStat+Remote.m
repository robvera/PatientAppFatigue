//
//  LabResultStat+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "LabResultStat+Remote.h"

@implementation LabResultStat (Remote)
...
+ (NSArray *)activeLabResultStatusesError:(NSError **)error {
    return [self query:@"active_lab_result_statuses" params:nil context:nil config:nil error:error];
}

+ (NSArray *)activeLabResultStatusesWithContext:(id)context error:(NSError **)error {
    return [self query:@"active_lab_result_statuses" params:nil context:context config:nil error:error];
}

+ (NSArray *)activeLabResultStatusesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    return [self query:@"active_lab_result_statuses" params:nil offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)activeLabResultStatusesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    return [self query:@"active_lab_result_statuses" params:nil offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeLabResultStatusesAsync:(APObjectsCallback)callback {
    return [self query:@"active_lab_result_statuses" params:nil context:nil config:nil async:callback];
}

+ (NSArray *)activeLabResultStatusesWithContext:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_lab_result_statuses" params:nil context:context config:nil async:callback];
}

+ (NSArray *)activeLabResultStatusesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    return [self query:@"active_lab_result_statuses" params:nil offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeLabResultStatusesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_lab_result_statuses" params:nil offset:offset limit:limit context:context config:nil async:callback];
}
