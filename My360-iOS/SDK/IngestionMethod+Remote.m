//
//  IngestionMethod+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "IngestionMethod+Remote.h"

@implementation IngestionMethod (Remote)
...
+ (NSArray *)activeIngestionMethodsError:(NSError **)error {
    return [self query:@"active_ingestion_methods" params:nil context:nil config:nil error:error];
}

+ (NSArray *)activeIngestionMethodsWithContext:(id)context error:(NSError **)error {
    return [self query:@"active_ingestion_methods" params:nil context:context config:nil error:error];
}

+ (NSArray *)activeIngestionMethodsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    return [self query:@"active_ingestion_methods" params:nil offset:offset limit:limit context:nil config:nil error:error];
}

+ (NSArray *)activeIngestionMethodsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    return [self query:@"active_ingestion_methods" params:nil offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeIngestionMethodsAsync:(APObjectsCallback)callback {
    return [self query:@"active_ingestion_methods" params:nil context:nil config:nil async:callback];
}

+ (NSArray *)activeIngestionMethodsWithContext:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_ingestion_methods" params:nil context:context config:nil async:callback];
}

+ (NSArray *)activeIngestionMethodsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    return [self query:@"active_ingestion_methods" params:nil offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeIngestionMethodsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_ingestion_methods" params:nil offset:offset limit:limit context:context config:nil async:callback];
}
