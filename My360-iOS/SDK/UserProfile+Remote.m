//
//  UserProfile+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "UserProfile+Remote.h"

@implementation UserProfile (Remote)
...
+ (NSArray *)myProfileWithId:(NSNumber *)id error:(NSError **)error {
    ...
    return [self query:@"my_profile" params:params context:nil config:nil error:error];
}

+ (NSArray *)myProfileWithId:(NSNumber *)id context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_profile" params:params context:context config:nil error:error];
}

+ (NSArray *)myProfileWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"my_profile" params:params offset:offset limit:limit context:nil config:nil error:error];
}

+ (NSArray *)myProfileWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_profile" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)myProfileWithId:(NSNumber *)id async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_profile" params:params context:nil config:nil async:callback];
}

+ (NSArray *)myProfileWithId:(NSNumber *)id context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_profile" params:params context:context config:nil async:callback];
}

+ (NSArray *)myProfileWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_profile" params:params offset:offset limit:limit context:nil config:nil async:callback];
}

+ (NSArray *)myProfileWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_profile" params:params offset:offset limit:limit context:context config:nil async:callback];
}
