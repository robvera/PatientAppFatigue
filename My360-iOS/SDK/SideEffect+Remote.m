...
#import "SideEffect+Remote.h"

@implementation SideEffect (Remote)
...
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId error:(NSError **)error {
    ...
    return [self query:@"active_side_effects" params:params context:nil config:nil error:error];
}
...
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error {
    ...
    return [self query:@"active_side_effects" params:params context:context config:nil error:error];
}
...
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"active_side_effects" params:params offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"active_side_effects" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_side_effects" params:params context:nil config:nil async:callback];
}
...
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_side_effects" params:params context:context config:nil async:callback];
}
...
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_side_effects" params:params offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"active_side_effects" params:params offset:offset limit:limit context:context config:nil async:callback];
}
