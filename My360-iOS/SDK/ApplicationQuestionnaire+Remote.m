//
//  ApplicationQuestionnaire+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "ApplicationQuestionnaire+Remote.h"

@implementation ApplicationQuestionnaire (Remote)
...
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId error:(NSError **)error {
    ...
    return [self query:@"my_app_questions" params:params context:nil config:nil error:error];
}
...
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_app_questions" params:params context:context config:nil error:error];
}
...
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    ...
    return [self query:@"my_app_questions" params:params offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    ...
    return [self query:@"my_app_questions" params:params offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_app_questions" params:params context:nil config:nil async:callback];
}
...
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_app_questions" params:params context:context config:nil async:callback];
}
...
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_app_questions" params:params offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    ...
    return [self query:@"my_app_questions" params:params offset:offset limit:limit context:context config:nil async:callback];
}
