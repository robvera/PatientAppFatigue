//
//  MissingTreatmentReason+Remote.m
//  AnyPresence SDK
//

#import "APObject+Remote.h"
#import "APObject+Internal.h"
#import "MissingTreatmentReason+Remote.h"

@implementation MissingTreatmentReason (Remote)
...
+ (NSArray *)activeMissingTreatmentsError:(NSError **)error {
    return [self query:@"active_missing_treatments" params:nil context:nil config:nil error:error];
}

+ (NSArray *)activeMissingTreatmentsWithContext:(id)context error:(NSError **)error {
    return [self query:@"active_missing_treatments" params:nil context:context config:nil error:error];
}

+ (NSArray *)activeMissingTreatmentsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    return [self query:@"active_missing_treatments" params:nil offset:offset limit:limit context:nil config:nil error:error];
}
...
+ (NSArray *)activeMissingTreatmentsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    return [self query:@"active_missing_treatments" params:nil offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeMissingTreatmentsAsync:(APObjectsCallback)callback {
    return [self query:@"active_missing_treatments" params:nil context:nil config:nil async:callback];
}

+ (NSArray *)activeMissingTreatmentsWithContext:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_missing_treatments" params:nil context:context config:nil async:callback];
}

+ (NSArray *)activeMissingTreatmentsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    return [self query:@"active_missing_treatments" params:nil offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeMissingTreatmentsWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_missing_treatments" params:nil offset:offset limit:limit context:context config:nil async:callback];
}
