...
#import "DosageUom+Remote.h"

@implementation DosageUom (Remote)
...
+ (NSArray *)activeDosageUomError:(NSError **)error {
    return [self query:@"active_dosage_uom" params:nil context:nil config:nil error:error];
}

+ (NSArray *)activeDosageUomWithContext:(id)context error:(NSError **)error {
    return [self query:@"active_dosage_uom" params:nil context:context config:nil error:error];
}

+ (NSArray *)activeDosageUomWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error {
    return [self query:@"active_dosage_uom" params:nil offset:offset limit:limit context:nil config:nil error:error];
}

+ (NSArray *)activeDosageUomWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error {
    return [self query:@"active_dosage_uom" params:nil offset:offset limit:limit context:context config:nil error:error];
}
...
+ (NSArray *)activeDosageUomAsync:(APObjectsCallback)callback {
    return [self query:@"active_dosage_uom" params:nil context:nil config:nil async:callback];
}

+ (NSArray *)activeDosageUomWithContext:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_dosage_uom" params:nil context:context config:nil async:callback];
}

+ (NSArray *)activeDosageUomWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback {
    return [self query:@"active_dosage_uom" params:nil offset:offset limit:limit context:nil config:nil async:callback];
}
...
+ (NSArray *)activeDosageUomWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback {
    return [self query:@"active_dosage_uom" params:nil offset:offset limit:limit context:context config:nil async:callback];
}
