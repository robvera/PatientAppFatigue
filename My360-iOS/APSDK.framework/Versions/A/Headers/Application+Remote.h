...
/*!
 ...
 @abstract Remote category for Application class
 */

#import "Application.h"

/*!
 @category Application (Remote)
 @abstract Adds remote CRUD capabilities to Application.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Application (Remote)
