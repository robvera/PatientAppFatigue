//
//  PatientSideEffectMedication+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientSideEffectMedication+Remote
 @abstract Remote category for PatientSideEffectMedication class
 */

#import "PatientSideEffectMedication.h"

/*!
 @category PatientSideEffectMedication (Remote)
 @abstract Adds remote CRUD capabilities to PatientSideEffectMedication.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientSideEffectMedication (Remote)
...
/*!
 @method unarchivedSideeffectMedsWithPatientSideEffectId:error:
 @abstract Fetches objects matching query scope "unarchived_sideeffect_meds" from remote server.
...
/*!
 @method unarchivedSideeffectMedsWithPatientSideEffectId:context:error:
 @abstract Fetches objects matching query scope "unarchived_sideeffect_meds" from remote server.
 @param patientSideEffectId Scope parameter - patientSideEffectId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method unarchivedSideeffectMedsWithPatientSideEffectId:offset:limit:error:
 @abstract Fetches objects matching query scope "unarchived_sideeffect_meds" from remote server, with pagination.
 @param patientSideEffectId Scope parameter - patientSideEffectId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method unarchivedSideeffectMedsWithPatientSideEffectId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "unarchived_sideeffect_meds" from remote server, with pagination.
 @param patientSideEffectId Scope parameter - patientSideEffectId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method unarchivedSideeffectMedsWithPatientSideEffectId:async:
 @abstract Returns cached objects matching query scope "unarchived_sideeffect_meds", then fetches fresh ones from remote server.
 @param patientSideEffectId Scope parameter - patientSideEffectId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method unarchivedSideeffectMedsWithPatientSideEffectId:context:async:
 @abstract Returns cached objects matching query scope "unarchived_sideeffect_meds", then fetches fresh ones from remote server.
 @param patientSideEffectId Scope parameter - patientSideEffectId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method unarchivedSideeffectMedsWithPatientSideEffectId:offset:limit:async:
 @abstract Returns cached objects matching query scope "unarchived_sideeffect_meds", then fetches fresh ones from remote server, with pagination.
 @param patientSideEffectId Scope parameter - patientSideEffectId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method unarchivedSideeffectMedsWithPatientSideEffectId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "unarchived_sideeffect_meds", then fetches fresh ones from remote server, with pagination.
 @param patientSideEffectId Scope parameter - patientSideEffectId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
