//
//  PatientFatigueAnswer+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientFatigueAnswer+Remote
 @abstract Remote category for PatientFatigueAnswer class
 */

#import "PatientFatigueAnswer.h"

/*!
 @category PatientFatigueAnswer (Remote)
 @abstract Adds remote CRUD capabilities to PatientFatigueAnswer.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientFatigueAnswer (Remote)
