...
/*!
 @header Medication+Remote
 @abstract Remote category for Medication class
 */

#import "Medication.h"

/*!
 @category Medication (Remote)
 @abstract Adds remote CRUD capabilities to Medication.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Medication (Remote)
...
/*!
 @method activeMedicationsWithAppId:error:
 @abstract Fetches objects matching query scope "active_medications" from remote server.
 @param appId Scope parameter - appId.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMedicationsWithAppId:(NSNumber *)appId error:(NSError **)error;

/*!
 @method activeMedicationsWithAppId:context:error:
 @abstract Fetches objects matching query scope "active_medications" from remote server.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMedicationsWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error;

/*!
 @method activeMedicationsWithAppId:offset:limit:error:
 @abstract Fetches objects matching query scope "active_medications" from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeMedicationsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method activeMedicationsWithAppId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "active_medications" from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of objects.
 */
+ (NSArray *)activeMedicationsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method activeMedicationsWithAppId:async:
 @abstract Returns cached objects matching query scope "active_medications", then fetches fresh ones from remote server.
 @param appId Scope parameter - appId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMedicationsWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback;

/*!
 @method activeMedicationsWithAppId:context:async:
 @abstract Returns cached objects matching query scope "active_medications", then fetches fresh ones from remote server.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMedicationsWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback;

/*!
 @method activeMedicationsWithAppId:offset:limit:async:
 @abstract Returns cached objects matching query scope "active_medications", then fetches fresh ones from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeMedicationsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method activeMedicationsWithAppId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "active_medications", then fetches fresh ones from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)activeMedicationsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
