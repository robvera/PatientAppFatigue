//
//  ApplicationQuestionnaire+Remote.h
//  AnyPresence SDK
//

/*!
 @header ApplicationQuestionnaire+Remote
 @abstract Remote category for ApplicationQuestionnaire class
 */

#import "ApplicationQuestionnaire.h"

/*!
 @category ApplicationQuestionnaire (Remote)
 @abstract Adds remote CRUD capabilities to ApplicationQuestionnaire.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface ApplicationQuestionnaire (Remote)
...
/*!
 @method myAppQuestionsWithAppId:error:
 @abstract Fetches objects matching query scope "my_app_questions" from remote server.
 @param appId Scope parameter - appId.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId error:(NSError **)error;

/*!
 @method myAppQuestionsWithAppId:context:error:
 @abstract Fetches objects matching query scope "my_app_questions" from remote server.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error;

/*!
 @method myAppQuestionsWithAppId:offset:limit:error:
 @abstract Fetches objects matching query scope "my_app_questions" from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method myAppQuestionsWithAppId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "my_app_questions" from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of objects.
 */
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method myAppQuestionsWithAppId:async:
 @abstract Returns cached objects matching query scope "my_app_questions", then fetches fresh ones from remote server.
 @param appId Scope parameter - appId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback;

/*!
 @method myAppQuestionsWithAppId:context:async:
 @abstract Returns cached objects matching query scope "my_app_questions", then fetches fresh ones from remote server.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback;

/*!
 @method myAppQuestionsWithAppId:offset:limit:async:
 @abstract Returns cached objects matching query scope "my_app_questions", then fetches fresh ones from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method myAppQuestionsWithAppId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "my_app_questions", then fetches fresh ones from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)myAppQuestionsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
