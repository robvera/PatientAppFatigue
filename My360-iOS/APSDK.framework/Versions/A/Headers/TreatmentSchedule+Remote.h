//
//  TreatmentSchedule+Remote.h
//  AnyPresence SDK
//

/*!
 @header TreatmentSchedule+Remote
 @abstract Remote category for TreatmentSchedule class
 */

#import "TreatmentSchedule.h"

/*!
 @category TreatmentSchedule (Remote)
 @abstract Adds remote CRUD capabilities to TreatmentSchedule.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface TreatmentSchedule (Remote)
...
/*!
 @method activeTreatmentSchedulesError:
 @abstract Fetches objects matching query scope "active_treatment_schedules" from remote server.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeTreatmentSchedulesError:(NSError **)error;

/*!
 @method activeTreatmentSchedulesWithContext:error:
 @abstract Fetches objects matching query scope "active_treatment_schedules" from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeTreatmentSchedulesWithContext:(id)context error:(NSError **)error;

/*!
 @method activeTreatmentSchedulesWithOffset:limit:error:
 @abstract Fetches objects matching query scope "active_treatment_schedules" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeTreatmentSchedulesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method activeTreatmentSchedulesWithOffset:limit:context:error:
 @abstract Fetches objects matching query scope "active_treatment_schedules" from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of objects.
 */
+ (NSArray *)activeTreatmentSchedulesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method activeTreatmentSchedulesAsync:
 @abstract Returns cached objects matching query scope "active_treatment_schedules", then fetches fresh ones from remote server.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeTreatmentSchedulesAsync:(APObjectsCallback)callback;

/*!
 @method activeTreatmentSchedulesWithContext:async:
 @abstract Returns cached objects matching query scope "active_treatment_schedules", then fetches fresh ones from remote server.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeTreatmentSchedulesWithContext:(id)context async:(APObjectsCallback)callback;

/*!
 @method activeTreatmentSchedulesWithOffset:limit:async:
 @abstract Returns cached objects matching query scope "active_treatment_schedules", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeTreatmentSchedulesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method activeTreatmentSchedulesWithOffset:limit:context:async:
 @abstract Returns cached objects matching query scope "active_treatment_schedules", then fetches fresh ones from remote server, with pagination.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)activeTreatmentSchedulesWithOffset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
