//
//  PatientAsthma+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientAsthma+Remote
 @abstract Remote category for PatientAsthma class
 */

#import "PatientAsthma.h"

/*!
 @category PatientAsthma (Remote)
 @abstract Adds remote CRUD capabilities to PatientAsthma.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientAsthma (Remote)
