//
//  PatientJournalSymptom+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientJournalSymptom+Remote
 @abstract Remote category for PatientJournalSymptom class
 */

#import "PatientJournalSymptom.h"

/*!
 @category PatientJournalSymptom (Remote)
 @abstract Adds remote CRUD capabilities to PatientJournalSymptom.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientJournalSymptom (Remote)
...
/*!
 @method unarchivedPatientJournalSympWithPatientJournalId:error:
 @abstract Fetches objects matching query scope "unarchived_patient_journal_symp" from remote server.
...
/*!
 @method unarchivedPatientJournalSympWithPatientJournalId:context:error:
 @abstract Fetches objects matching query scope "unarchived_patient_journal_symp" from remote server.
 @param patientJournalId Scope parameter - patientJournalId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method unarchivedPatientJournalSympWithPatientJournalId:offset:limit:error:
 @abstract Fetches objects matching query scope "unarchived_patient_journal_symp" from remote server, with pagination.
 @param patientJournalId Scope parameter - patientJournalId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
...
/*!
 @method unarchivedPatientJournalSympWithPatientJournalId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "unarchived_patient_journal_symp" from remote server, with pagination.
 @param patientJournalId Scope parameter - patientJournalId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
...
/*!
 @method unarchivedPatientJournalSympWithPatientJournalId:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_journal_symp", then fetches fresh ones from remote server.
 @param patientJournalId Scope parameter - patientJournalId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
...
/*!
 @method unarchivedPatientJournalSympWithPatientJournalId:context:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_journal_symp", then fetches fresh ones from remote server.
 @param patientJournalId Scope parameter - patientJournalId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method unarchivedPatientJournalSympWithPatientJournalId:offset:limit:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_journal_symp", then fetches fresh ones from remote server, with pagination.
 @param patientJournalId Scope parameter - patientJournalId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
...
/*!
 @method unarchivedPatientJournalSympWithPatientJournalId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "unarchived_patient_journal_symp", then fetches fresh ones from remote server, with pagination.
 @param patientJournalId Scope parameter - patientJournalId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
