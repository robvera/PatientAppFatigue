//
//  PatientCaregiver+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientCaregiver+Remote
 @abstract Remote category for PatientCaregiver class
 */

#import "PatientCaregiver.h"

/*!
 @category PatientCaregiver (Remote)
 @abstract Adds remote CRUD capabilities to PatientCaregiver.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientCaregiver (Remote)
...
/*!
 @method myCaregiverWithId:error:
 @abstract Fetches objects matching query scope "my_caregiver" from remote server.
 @param id Scope parameter - id.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myCaregiverWithId:(NSNumber *)id error:(NSError **)error;

/*!
 @method myCaregiverWithId:context:error:
 @abstract Fetches objects matching query scope "my_caregiver" from remote server.
 @param id Scope parameter - id.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myCaregiverWithId:(NSNumber *)id context:(id)context error:(NSError **)error;

/*!
 @method myCaregiverWithId:offset:limit:error:
 @abstract Fetches objects matching query scope "my_caregiver" from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myCaregiverWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method myCaregiverWithId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "my_caregiver" from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of objects.
 */
+ (NSArray *)myCaregiverWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method myCaregiverWithId:async:
 @abstract Returns cached objects matching query scope "my_caregiver", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myCaregiverWithId:(NSNumber *)id async:(APObjectsCallback)callback;

/*!
 @method myCaregiverWithId:context:async:
 @abstract Returns cached objects matching query scope "my_caregiver", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myCaregiverWithId:(NSNumber *)id context:(id)context async:(APObjectsCallback)callback;

/*!
 @method myCaregiverWithId:offset:limit:async:
 @abstract Returns cached objects matching query scope "my_caregiver", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myCaregiverWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method myCaregiverWithId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "my_caregiver", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)myCaregiverWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
