...
/*!
 @header SideEffect+Remote
 @abstract Remote category for SideEffect class
 */

#import "SideEffect.h"

/*!
 @category SideEffect (Remote)
 @abstract Adds remote CRUD capabilities to SideEffect.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface SideEffect (Remote)
...
/*!
 @method activeSideEffectsWithAppId:error:
 @abstract Fetches objects matching query scope "active_side_effects" from remote server.
 @param appId Scope parameter - appId.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId error:(NSError **)error;

/*!
 @method activeSideEffectsWithAppId:context:error:
 @abstract Fetches objects matching query scope "active_side_effects" from remote server.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId context:(id)context error:(NSError **)error;

/*!
 @method activeSideEffectsWithAppId:offset:limit:error:
 @abstract Fetches objects matching query scope "active_side_effects" from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method activeSideEffectsWithAppId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "active_side_effects" from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of objects.
 */
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method activeSideEffectsWithAppId:async:
 @abstract Returns cached objects matching query scope "active_side_effects", then fetches fresh ones from remote server.
 @param appId Scope parameter - appId.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId async:(APObjectsCallback)callback;

/*!
 @method activeSideEffectsWithAppId:context:async:
 @abstract Returns cached objects matching query scope "active_side_effects", then fetches fresh ones from remote server.
 @param appId Scope parameter - appId.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId context:(id)context async:(APObjectsCallback)callback;

/*!
 @method activeSideEffectsWithAppId:offset:limit:async:
 @abstract Returns cached objects matching query scope "active_side_effects", then fetches fresh ones from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method activeSideEffectsWithAppId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "active_side_effects", then fetches fresh ones from remote server, with pagination.
 @param appId Scope parameter - appId.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)activeSideEffectsWithAppId:(NSNumber *)appId offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
