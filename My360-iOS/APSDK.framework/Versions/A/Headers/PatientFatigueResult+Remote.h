//
//  PatientFatigueResult+Remote.h
//  AnyPresence SDK
//

/*!
 @header PatientFatigueResult+Remote
 @abstract Remote category for PatientFatigueResult class
 */

#import "PatientFatigueResult.h"

/*!
 @category PatientFatigueResult (Remote)
 @abstract Adds remote CRUD capabilities to PatientFatigueResult.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface PatientFatigueResult (Remote)
...
/*!
 @method myUnarchivedFatigueWithId:error:
 @abstract Fetches objects matching query scope "my_unarchived_fatigue" from remote server.
 @param id Scope parameter - id.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id error:(NSError **)error;

/*!
 @method myUnarchivedFatigueWithId:context:error:
 @abstract Fetches objects matching query scope "my_unarchived_fatigue" from remote server.
 @param id Scope parameter - id.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id context:(id)context error:(NSError **)error;

/*!
 @method myUnarchivedFatigueWithId:offset:limit:error:
 @abstract Fetches objects matching query scope "my_unarchived_fatigue" from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param error Error that has occured while executing the request, if any.
 @result Array of objects.
 */
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit error:(NSError **)error;

/*!
 @method myUnarchivedFatigueWithId:offset:limit:context:error:
 @abstract Fetches objects matching query scope "my_unarchived_fatigue" from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of objects.
 */
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context error:(NSError **)error;
...
/*!
 @method myUnarchivedFatigueWithId:async:
 @abstract Returns cached objects matching query scope "my_unarchived_fatigue", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id async:(APObjectsCallback)callback;

/*!
 @method myUnarchivedFatigueWithId:context:async:
 @abstract Returns cached objects matching query scope "my_unarchived_fatigue", then fetches fresh ones from remote server.
 @param id Scope parameter - id.
 @param context Object instance or NSDictionary of ‘string’ to ‘object instance’ mapping for use with interpolation of headers, request URL, or previously defined variable at SDK creation.  For more details on the use of contexts, see the discussion section in @link //apple_ref/occ/cat/APObject(Remote) @/link.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id context:(id)context async:(APObjectsCallback)callback;

/*!
 @method myUnarchivedFatigueWithId:offset:limit:async:
 @abstract Returns cached objects matching query scope "my_unarchived_fatigue", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 @param callback Callback to be executed when operation completes.
 @result Array of cached objects.
 */
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit async:(APObjectsCallback)callback;

/*!
 @method myUnarchivedFatigueWithId:offset:limit:context:async:
 @abstract Returns cached objects matching query scope "my_unarchived_fatigue", then fetches fresh ones from remote server, with pagination.
 @param id Scope parameter - id.
 @param offset Number of objects to skip.
 @param limit Maximum number of objects to fetch.
 ...
 @result Array of cached objects.
 */
+ (NSArray *)myUnarchivedFatigueWithId:(NSNumber *)id offset:(NSUInteger)offset limit:(NSUInteger)limit context:(id)context async:(APObjectsCallback)callback;
